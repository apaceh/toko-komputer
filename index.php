<?php
  ...
  $produk = query("SELECT * FROM barang LIMIT $awalData, $jumlahDataPerhalaman");
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavId">
      ...
      <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"> Sign In</i></a>
          <div class="dropdown-menu form-wrapper" aria-labelledby="dropdownId">
            <form action="login.php" method="post">
              <div class="form-group">                  
                <input type="text" class="form-control form-control-sm" name="username" id="username" aria-describedby="emailHelpId" placeholder="Username">
              </div>
              <div class="form-group">                  
              ...
              <p class="form-text">
                  Belum ada akun? Register <a href="register.php">disini</a>.
              </p>
            </form>
          </div>
        </li>        
              ...
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-footer">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <a class="btn btn-sm btn-outline-success view_data" href="cart.php?kd_barang=<?= $row['kd_barang']; ?>&nama_barang=<?= $row['nama_barang'];?>" role="button"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
